...
const Paroxes = () => {
  return (
    <div>
      <section>
        <h1 className="text-center text-2xl underline font-bold text-custom-new-blue mt-20 mb-10">
          ΠΑΡΟΧΕΣ
        </h1>
        <h3 className="text-left text-2xl underline font-bold text-custom-new-blue ml-2 mb-5">
          Κλάδος ΕΦΑΠΑΞ
        </h3>
        <div className="text-lg ml-4 bg-blue-100 px-6 py-4 rounded-lg shadow-md border-l-4 border-blue-500">
        ...
        <div>
          <div className="text-left mt-10">
            ...
            <div className="text-left text-lg ml-4 bg-blue-100 px-6 py-4 rounded-lg shadow-md border-l-4 border-blue-500 mb-5">
          ...
          <div className="text-lg text-left ml-4 bg-blue-100 px-6 py-4 rounded-lg shadow-md border-l-4 border-blue-500">
            <p className="text-gray-700 text-1xl font-semibold  ">
        ...
        <div className="text-left mb-10">
          <h1 className="text-left text-xl underline font-bold text-custom-new-blue ml-2  mb-5">
            Προϋποθέσεις θεμελίωσης δικαιώματος σε παροχή
          </h1>
          <p className="text-1xl underline ml-2 ">
            Ο ασφαλισμένος δικαιούται εφάπαξ παροχή από το Ταμείο εφόσον
            συντρέχουν στο πρόσωπό του οι ακόλουθες προϋποθέσεις:
          </p>
          <ul className=" text-1xl list-disc pl-6 mt-3 space-y-2 mb-10">
            <li className="bg-white p-4 rounded-lg shadow-md mt-10 hover:text-white hover:bg-custom-new-blue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
            ...
            <li className="bg-white p-4 rounded-lg shadow-md mt-10 hover:text-white hover:bg-custom-new-blue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
              Τα πρώην μέλη του ΛΑΜΔΕΑ τα οποία εγγράφονται στο Ταμείο και
            ...
            <li className="bg-white p-4 rounded-lg shadow-md mt-10 hover:text-white hover:bg-custom-new-blue shadow-lg transition delay-50 duration-300 ease-in-out hover:scale-105 transform">
              Σε περίπτωση αποστρατείας από την ενεργό υπηρεσία, ανεξαρτήτως
        ...
        <div className="text-left  mt-10">
          <div className="mb-10">
            ...
            <p className="text-lg ml-4 bg-blue-100 px-6 py-4 rounded-lg shadow-md border-l-4 border-blue-500">
