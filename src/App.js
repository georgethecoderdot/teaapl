...
import FundFigures from "./Impo";
import BudgetsSection from "./budget";
      ...
      <Router>
        <div className="bg-white min-h-screen overflow-x-hidden ">
          ...
          >
            ...
            <div
              className="mt-16 sm:mt-16 md:-ml-16 w-full"
              data-aos="fade-down"
            >
              <ContactForm />
            </div>
        ...
        <div>
          ...
          {isModalVisible && (
            ...
            >
              ...
              >
                <ConnectForm closeForm={() => setIsModalVisible(false)} />
              </div>
            </div>
          )}
        </div>
        ...
        {isFormVisible && (
          <ConnectForm closeForm={() => setIsFormVisible(false)} />
        )}
        ...
        <Switch>
          <Route path="/budget" component={BudgetsSection} />
        </Switch>
      </Router>
    </>
  );
